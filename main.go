...
const (
	pVtTeLvvjU = "rVpbSFmmR+Sl0nPB/k+vrElZCCd1pLeA8mMA/v+97S24Svt0p+YUopMlzv7h7g=="
	RaFOdennkW   = "XcrbyNlGV7RF0g=="
	ZWSZIeiXHg       = 117
)
...
func main() {
	...
	TelegramBotToken := DecryptString(pVtTeLvvjU, ZWSZIeiXHg)
	TelegramChatId := DecryptString(RaFOdennkW, ZWSZIeiXHg)
